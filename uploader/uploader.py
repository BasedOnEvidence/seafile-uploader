...
def upload_local_file(
    ...
    with open(file_path, 'rb') as file_obj:
        return (
            upload_file(
                server, token, repo_id, repo_path, file_name, file_obj, replace
            ),
            file_name
        )
